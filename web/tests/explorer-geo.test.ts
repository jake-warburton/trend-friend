  ...
  const trends: TrendExplorerRecord[] = [
    {
      ...
      score: { total: 12, social: 3, developer: 5, knowledge: 2, search: 2, diversity: 0 },
    ...
    },
    {
      ...
      firstSeenAt: null,
      latestSignalAt: "2026-03-12T10:00:00Z",
      score: { total: 10, social: 4, developer: 2, knowledge: 2, search: 2, diversity: 0 },
...
function buildDetailRecord(
  ...
  return {
    ...
    firstSeenAt: null,
    latestSignalAt: "2026-03-12T10:00:00Z",
    score: { total: 10, social: 2, developer: 4, knowledge: 2, search: 2, diversity: 0 },
    momentum: { previousRank: null, rankChange: null, absoluteDelta: null, percentDelta: null },
