    ...
    trends: [
      {
        ...
        score: { total: 42, social: 15, developer: 10, knowledge: 6, search: 5, advertising: 0, diversity: 6 },
      } as any,
    ],
  };
  ...
  const result = buildFallbackTrendDetailFromExplorer(
    {
      ...
      score: { total: 14.4, social: 1.2, developer: 9.4, knowledge: 0.8, search: 1.1, advertising: 0, diversity: 1.9 },
