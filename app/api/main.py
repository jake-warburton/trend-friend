...
from app.api.routers import ad_intelligence, alerts, auth, billing, community, dashboard, exports, notifications, predictions, stripe_webhooks, trends, sources, refresh, watchlists
...
def create_app() -> FastAPI:
    ...
    application.include_router(ad_intelligence.router, prefix="/api/v1")
