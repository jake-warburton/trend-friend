...
POSTGRES_MIGRATIONS = [
    ...
    Migration("0012_trend_metric_snapshots", load_sql_migration("postgres_migrations/0012_trend_metric_snapshots.sql")),
    ...
    Migration("0019_twitter_trends", load_sql_migration("postgres_migrations/0019_twitter_trends.sql")),
]
