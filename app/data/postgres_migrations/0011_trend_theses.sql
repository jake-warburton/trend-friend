...
CREATE TABLE IF NOT EXISTS trend_thesis_matches (
    thesis_id BIGINT NOT NULL REFERENCES trend_theses (id) ON DELETE CASCADE,
    trend_id TEXT NOT NULL,
    trend_name TEXT NOT NULL,
    active INTEGER NOT NULL DEFAULT 1,
    first_matched_at TIMESTAMPTZ NOT NULL,
    last_matched_at TIMESTAMPTZ NOT NULL,
    lens_score DOUBLE PRECISION NOT NULL DEFAULT 0,
...
ALTER TABLE alert_rules ADD COLUMN IF NOT EXISTS thesis_id BIGINT NULL REFERENCES trend_theses (id) ON DELETE CASCADE;
